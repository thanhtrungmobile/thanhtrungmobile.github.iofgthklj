...
#define PLIST_PATH @"/var/mobile/Library/Preferences/com.antique.glimpse.plist"
...
@interface CCGlimpsePageViewController : UIViewController <CCUIControlCenterPageContentProviding>
@end
...
- (BOOL)isPresented;
- (void)glimpse_displayFirstRunAlert;
@end
