...
- (void)updateBodyLayer
{
    ...
    UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(x1, y1, width1, height1) cornerRadius:MIN(width1, height1) / 13.5f];
...
- (void)setBatteryLevel:(NSInteger)batteryLevel
{
    ...
    UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(CGRectGetWidth(self.frame) * kBatteryBodyFillInsetX, CGRectGetHeight(self.frame) * kBatteryBodyFillInsetY, width * (1.f - 2.f * kBatteryBodyFillInsetX), height * (1.f - 2.f * kBatteryBodyFillInsetY)) cornerRadius:MIN(width, height) / 13.5f];
