...
#define PLIST_PATH @"/var/mobile/Library/Preferences/com.antique.orca.plist"
...
@interface CCAlegroPageViewController : UIViewController <CCUIControlCenterPageContentProviding, UITextViewDelegate>
...
- (BOOL)isPresented;
- (void)alegro_displayFirstRunAlert;
@end
